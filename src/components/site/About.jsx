        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid lg:grid-cols-12 gap-12 lg:gap-20 items-center">
            <div className="lg:col-span-6 order-2 lg:order-1 relative">
                <div className="aspect-[4/5] overflow-hidden grain">
                    <img
    src="https://images.unsplash.com/photo-1677083969492-42e69b1fe9c7?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NTY2NzV8MHwxfHNlYXJjaHwyfHxlbGVnYW50JTIwcGhvdG9ncmFwaHklMjBzdHVkaW98ZW58MHx8fHwxNzc2OTUzOTYyfDA&ixlib=rb-4.1.0&q=85"
